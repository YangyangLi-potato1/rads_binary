...
def main():
    ...
    model.load_state_dict(torch.load("C:/YangLi/JHU-PET-CT/data20221013/PSMA_CLASSIFICATION_DATA/Trained model-fuse input-concatenation/best_metric_classification3d_dict.pth"))
    ...
    with torch.no_grad():
        num_correct=0
        metric_count=0
        saver=CSVSaver(output_dir="./output-single-multi-concate")
